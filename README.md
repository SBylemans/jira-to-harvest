...
5. Existing Harvest entries for the month are fetched and the daily total is capped at `$DAILY_HOUR_LIMIT` hours. If new entries would exceed the cap they are scaled proportionally with a warning.
